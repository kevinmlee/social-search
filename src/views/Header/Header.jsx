...
const Header = () => {
  ...
  return (
    <div id="header" className="sticky top-0 z-50">
      <header className={`pl-10 bg-white dark:bg-[#161819] md:pl-[215px] shadow-lg py-2 ${scrollStatus === 'scrolled' ? 'md:py-2' : 'md:py-4'} transition-all duration-300 ease-in-out`}>
